...
import { ssrRenderAttrs, ssrGetDirectiveProps, ssrRenderComponent, ssrRenderAttr, ssrRenderList, ssrInterpolate, ssrRenderSuspense, ssrRenderVNode } from 'vue/server-renderer';
import 'node:http';
import 'node:https';
import 'fs';
import 'path';
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./_nuxt/index-e9JbAcyq.mjs').then((m) => m.default || m)
  },
  {
    name: "rating",
    path: "/rating",
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./_nuxt/rating-gsqkzwcf.mjs').then((m) => m.default || m)
  },
  {
    name: "services",
    path: "/services",
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./_nuxt/services-eQi4WPo7.mjs').then((m) => m.default || m)
  }
];
...
const layouts = {
  default: () => import('./_nuxt/default-_EhgwqXF.mjs').then((m) => m.default || m)
};
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<header${ssrRenderAttrs(mergeProps({
    initial: { opacity: 1e-3 },
    enter: { opacity: 1 },
    delay: 1e3,
    class: ["ev-header", { "bg-gray-50/10 backdrop-blur-2xl ml-4": $data.menuIsOpen }]
  }, _attrs, ssrGetDirectiveProps(_ctx, _directive_motion)))} data-v-ad8ef14b><div class="w-full flex items-center justify-center sm:justify-between transition-all text-gray-700" data-v-ad8ef14b>`);
  _push(ssrRenderComponent(_component_NuxtLink, {
    class: "sm:ml-0 sm:mr-auto flex justify-center sm:space-x-3 items-center",
    to: "/"
  }, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<img class="hidden sm:block select-none w-10 h-10 sm:w-12 sm:h-8 md:w-16 md:h-10 opacity-80"${ssrRenderAttr("src", _imports_0)} alt="no img" data-v-ad8ef14b${_scopeId}><h2 class="text-fuchsia-50/80 hover:text-red-300 transition-colors duration-300 font-sans font-medium text-base lg:text-lg" data-v-ad8ef14b${_scopeId}> Everest consulting </h2>`);
      } else {
        return [
          createVNode("img", {
            onClick: ($event) => $data.activePage = 0,
            class: "hidden sm:block select-none w-10 h-10 sm:w-12 sm:h-8 md:w-16 md:h-10 opacity-80",
            src: _imports_0,
            alt: "no img"
          }, null, 8, ["onClick"]),
          createVNode("h2", { class: "text-fuchsia-50/80 hover:text-red-300 transition-colors duration-300 font-sans font-medium text-base lg:text-lg" }, " Everest consulting ")
        ];
      }
    }),
    _: 1
  }, _parent));
  _push(`<nav class="hidden sm:block" data-v-ad8ef14b><ul class="flex items-center justify-center space-x-3.5" data-v-ad8ef14b>`);
  _push(ssrRenderComponent(_component_NuxtLink, {
    id: "1",
    to: "/services",
    class: "text-fuchsia-50/80 rounded-xl hover:text-red-300 transition-colors duration-300 cursor-pointer"
  }, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(` Услуги `);
  ...
  _push(`</ul></nav><div class="ml-auto block sm:hidden flex items-center" data-v-ad8ef14b><svg class="cursor-pointer w-10 h-10 sm:ml-4 text-gray-200" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" data-v-ad8ef14b><path stroke-linecap="round" stroke-linejoin="round" d="M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25h16.5" data-v-ad8ef14b></path></svg></div></div>`);
  if ($data.menuIsOpen) {
    ...
    }, ssrGetDirectiveProps(_ctx, _directive_motion)))} data-v-ad8ef14b><ul class="flex flex-col gap-y-4 mt-4 text-gray-200" data-v-ad8ef14b><!--[-->`);
    ssrRenderList($data.navLinks, (link) => {
      _push(`<li class="cursor-pointer" data-v-ad8ef14b>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: link.url
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<h5 class="text-sm font-sans font-medium" data-v-ad8ef14b${_scopeId}>${ssrInterpolate(link.title)}</h5>`);
          } else {
            return [
              createVNode("h5", { class: "text-sm font-sans font-medium" }, toDisplayString(link.title), 1)
            ];
          }
        }),
        _: 2
...
const evHeader = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["ssrRender", _sfc_ssrRender$1], ["__scopeId", "data-v-ad8ef14b"]]);
const _sfc_main$2 = {
  components: {
    EvHeader: evHeader
  }
